...
lazy_static! {
    pub static ref ORDER: BigUint = BigUint::from_bytes_be(&[
        0x00, 0x01, 0x02, 0x6d, 0xd8, 0x50, 0x81, 0xb8, 0x23, 0x14, 0x69, 0x1c, 0xed, 0x9b, 0xbe,
        0xc3, 0x05, 0x47, 0x84, 0x0e, 0x4b, 0xf7, 0x2d, 0x8b, 0x5e, 0x0d, 0x25, 0x84, 0x42, 0xbb,
        0xcd, 0x31,
    ]);
}
...
pub fn hash(msg: String) -> Vec<u8> {
    ...
    ret.extend(vec![
        0x43, 0x8d, 0xfd, 0x0f, 0x7c, 0x3c, 0xe3, 0xb4, 0xd1, 0x1b,
    ]);

    ret
}

pub fn sign(msg: String, priv_key: Vec<u8>) -> (BigUint, BigUint) {
